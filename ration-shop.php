...
<div id="page-calendar" class="page">
  <div class="container">
    ...
    <div style="margin-bottom:1rem">
      <select id="calShopFilter" onclick="renderCalendar()" style="max-width:280px">
    ...
    <div class="subscribe-grid">
      ...
      <div class="subscribe-box">
		...
		<div class="form-group">
            ...
            <select id="sub-shop" required onChange="callDropDown()">
          ...
          <div class="form-group">
            ...
            <div class="radio-group">
              <label class="radio-item"><input type="radio" name="notify" value="sms"/> SMS</label>
...
*/
// please Ignore the above as the calender is Hardcored to strictly view February 2026

function renderMiniCalendar(sched) {
    const today = new Date();

    // Dynamic current year & month
  ...
  function submitForm(e) {
    ...
    const notify1= document.querySelector('input[name="notify"]:checked');
    const errEl = document.getElementById('form-error');
	var notify = notify1.value;
  ...
  const subscribeData = {
    userName:name,
	item: document.getElementById('sub-item').value.trim(), 
	notifyVia:notify,
	phone:phone,
	shopId:shop
  };
	updateShopsToDB(subscribeData);
  }
  function updateShopsToDB(jsonData){
	fetch('AddSubscribers.php', {
